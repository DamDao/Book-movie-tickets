                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mt-3">
                                            <a href="{{ route('room.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name"
                                                    ...
                                                    placeholder="Enter product title" value="{{$room->name}}" required >
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="seat_count"
                                                    id="product-title-input"
                                                    placeholder="Enter product title" value="{{$room->seat_count}}" required>
